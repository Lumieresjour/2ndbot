const profiles = [
  { token: "-", // Replace with your Endfield cred cookie value ( get from cookie GI)
    genshin: true, 
    honkai_star_rail: false, 
    honkai_3: false, 
    accountName: "GI" },
  { token: "-", // Replace with your Endfield cred cookie value ( get from cookie HSR)
    genshin: false, 
...
const myDiscordID = "-" // Replace with your Discord ID to get pinged when an error occurs. Leave empty if you don't want to be pinged.
const myDiscordName = "-" // Replace with your Discord name to get pinged when an error occurs. Leave empty if you don't want to be pinged.
const discordWebhook = "-" // Replace with your Discord webhook URL to get notified when an error occurs. Leave empty if you don't want to be notified.
